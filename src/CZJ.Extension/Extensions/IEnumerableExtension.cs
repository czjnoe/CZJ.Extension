namespace CZJ.Extension
{
    public static class IEnumerableExtension
    {
        ...
        /// <returns></returns>
        public static IEnumerable<TSource> DistinctByFiled<TSource, TKey>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
        {
        ...
        /// <returns></returns>
        public static IEnumerable<t> RandomizedSort<t>(this IEnumerable<t> target)
        {
