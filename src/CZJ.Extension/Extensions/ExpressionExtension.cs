namespace CZJ.Extension
{
    ...
    public static class ExpressionExtension
    {
        ...
        {
            return left.Equal(Constant(value, left));
        }
        ...
        {
            return left.NotEqual(Constant(value, left));
        }
        ...
        {
            return left.Greater(Constant(value, left));
        }
        ...
        {
            return left.GreaterEqual(Constant(value, left));
        }
        ...
        {
            return left.Less(Constant(value, left));
        }
        ...
        {
            return left.LessEqual(Constant(value, left));
        }
