...
namespace CZJ.Extension.Helper
{
    ...
    public class FileWatcher : IDisposable
    {
        ...
        public FileWatcher OnError(Action<object, System.IO.ErrorEventArgs> action)
        {
        ...
        /// </summary>
        /// <param name="action">文件错误监听事件处理器</param>
        public FileWatcher OnErrorAsync(Func<object, System.IO.ErrorEventArgs, Task> action)
        {
    ...
    /// 文件监视事件过滤器
    /// </summary>
    public class FileWatcherEventFilter
    {
        /// <summary>
        /// 最后一个文件
        /// </summary>
