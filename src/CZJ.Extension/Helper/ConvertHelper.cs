...
namespace CZJ.Extension.Helper
{
    ...
    public static class ConvertHelper
    {
        ...
        {
            var success = float.TryParse(input.ToString(), out var result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            var success = double.TryParse(input.ToString(), out var result);
            if (!success)
                return null;
            if (digits == null)
                return result;
        ...
        {
            var success = DateTime.TryParse(input.ToString(), out var result);
            if (success == false)
                return null;
            return result;
        }
        ...
        public static Guid? ToGuidOrNull(object input)
        {
            ...
            return Guid.TryParse(input.ToString(), out var result) ? result : null;
        }
